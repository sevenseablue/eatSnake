window.onload = function(){
    ...
    var Snake = function(width,height,snakeId1,snakeId2,speed,isAuto){
        this.width = width || 20 ;	//创建地图的行跟列数
        this.height = height || 20 ;
        this.snakeId1 = snakeId1 || 'snake1' ;	//创建的表格id
        this.snakeId2 = snakeId2 || 'snake2' ;	//创建的表格id
        this.Grid = [] ;	//存放td对象的数组(二维)
        this.snakeGrid1 = [] ;	//存放蛇的数组
        this.snakeGrid2 = [] ;	//存放蛇的数组
    ...
    Snake.prototype = {
        ...
        initSnake:function(){
            this.snakeGrid1 = [] ;
            this.snakeGrid1.push([1,3]);
            this.snakeGrid1.push([1,2]);
            this.snakeGrid1.push([1,1]);

            this.snakeGrid2 = [] ;
            this.snakeGrid2.push([10,3]);
            this.snakeGrid2.push([10,2]);
            this.snakeGrid2.push([10,1]);
            //设置蛇的背景色
            this.painSnake(this.snakeGrid1);
            this.painSnake(this.snakeGrid2);
            //设置蛇头的背景色
            this.Grid[this.snakeGrid1[0][0]][this.snakeGrid1[0][1]].className = "snake_head";
            this.Grid[this.snakeGrid2[0][0]][this.snakeGrid2[0][1]].className = "snake_head";
        },
        //食物
        initfood:function(){
